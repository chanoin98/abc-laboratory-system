...
public class LabResult {
	...
	public LabResult(int resultNo, String patientName, int testRefno, int testCode,String testName
	...
	public LabResult(String patientName, int testRefno, int testCode,String testName,
			String testResult,String testComment) {
		this.patientName = patientName;
		this.testRefno = testRefno;
		this.testCode = testCode;
